...
Shader ResourceManager::load_shader(const char *vert_src, const char *frag_src,
...
Texture ResourceManager::load_texture(const char *file, const std::string &name,
                                      bool alpha) {
...
Shader ResourceManager::load_shader_file(const char *vert_src,
                                         const char *frag_src) {
...
Texture ResourceManager::load_texture_file(const char *file, bool alpha) {
  ...
  // weird bug:
  // https://computergraphics.stackexchange.com/questions/9671/texture-loading-erratic-working
